...
from auth_service import authenticate_user, register_user, resolve_session, revoke_session
...
def _public_payment(result: dict) -> dict[str, object]:
    return {key: result[key] for key in PUBLIC_PAYMENT_FIELDS if key in result}
