...
class Order(Base):
    ...
    __table_args__ = (UniqueConstraint("public_id", name="uq_order_public_id"), Index("idx_orders_status", "status"))

    id = Column(Integer, primary_key=True)
    public_id = Column(String(36), nullable=False, unique=True)
    user_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
    plan_id = Column(Integer, ForeignKey("premium_plans.id", ondelete="RESTRICT"), nullable=False)
...
class PaymentEvent(Base):
    ...
    __table_args__ = (UniqueConstraint("event_key", name="uq_payment_event_key"), Index("idx_payment_event_payment", "payment_id"))
