...
(function (global) {
  ...
  Storage.prototype.setItem = function (key, value) {
    ...
    // Legacy writers historically did {remaining: n} or {used: 0, ...}.
    // Never let such a partial snapshot erase a known server-authoritative
    // identity/consumption state for the same signed-in user.
    ...
    // Do not manufacture a different user's identity. New-account snapshots
    // written by auth_api_client.js already contain the new userKey.
  ...
  // One authoritative refresh immediately after the rest of the UI modules
  // have booted. No purchase and no test consumption are triggered here.
  function refresh() {
    try {
