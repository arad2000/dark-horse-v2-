...
(function (global) {
  ...
  function normalizePurchaseButton() {
    ...
    if (buy) {
      if (buy.textContent !== 'خرید بسته ۳ تست') buy.textContent = 'خرید بسته ۳ تست';
      if (buy.getAttribute('data-testid') !== 'purchase-pack-3') buy.setAttribute('data-testid', 'purchase-pack-3');
    }
