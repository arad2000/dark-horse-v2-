/* pwa-boot.js v51 — force SW update + one reload */
(function () {
  'use strict';
  ...
  if ('serviceWorker' in navigator) {
    ...
    window.addEventListener('load', function () {
      ...
      navigator.serviceWorker.addEventListener('controllerchange', function () {
        ...
        try {
          if (sessionStorage.getItem('dh_sw_reloaded_v51') === '1') return;
          sessionStorage.setItem('dh_sw_reloaded_v51', '1');
        } catch (e) {}
        refreshing = true;
