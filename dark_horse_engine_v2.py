"""
Dark Horse Engine V2.0 — هماهنگ با سؤالات و وزن‌های بازطراحی‌شده
trait_map و value_poles مستقیماً از فایل‌های JSON خوانده می‌شوند.
"""
