...
EXPECTED_TABLES = {
    ...
    "phone_verifications", "premium_plans", "orders", "payments", "entitlements", "payment_events", "admin_audit_logs",
}
EXPECTED_COLUMNS = {
    ...
    "user_sessions": {"id", "session_uuid", "micro_motives", "sjt_answers", "conjoint_choices", "user_id", "result_summary"},
    ...
    "phone_verifications": {"id", "challenge_id", "phone", "purpose", "name", "password_hash", "code_hash", "attempts", "expires_at", "verified_at"},
